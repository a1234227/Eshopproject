    ...
    <div class="row" id="total_content">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6">
                <form action="prokindcud" method="POST">
                    <div class="form-group row">
                        種類名稱
                        <div class="col-sm-10">
                            <input class="form-control form-control-sm" type="text" name="enum_name" required="required" value="<%=request.getParameter("enum_name")%>">
                        </div>
                    </div>

                    <div id="our_button">
                        <br>
                        <button type="submit" class="btn btn-danger" value="update" name="buttonAction">送出</button>
                        　　　　　　　　　　　<!-- 請不要刪除這行全形空格，按鈕會跑版 -->
                       	<button type="reset" class="btn btn-secondary">取消重填</button> 
                 	  	<input type="hidden" name="status" value="update">
						<input type="hidden" name="enum_id" value="<%=request.getParameter("enum_id")%>">
                    </div>
                </form>
