    ...
    <div class="row" id="total_content">
        ...
        <div class="col-sm-10" id="our_content">
          <!--查詢功能-->
                <h3>顧客清單管理/查詢</h3>
                                <br>
				<p><span style="background-color: #7683a8;padding: 10px;border-radius: 1px;color: #FFFFFF">總共 <%=customer_member.size()%> 位顧客</span></p>
                <div id="wfix">
            ...
            <table class="table">
				...
				%>
                    ...
                    <tr>
                    	...
                    	<!-- 打印更新連結 -->
                    	<td>
                    	<a href="customer_update.jsp?cust_id=<%=customer_member.get(i).getCust_id()%>&cust_name=<%=customer_member.get(i).getCust_name()%>&cust_account=<%=customer_member.get(i).getCust_account()%>&cust_password=<%=customer_member.get(i).getCust_password()%>&cust_address=<%=customer_member.get(i).getCust_address()%>">
                    	更新
                    	</a>
                    	</td>

						<td>
						<a href="custrud?cust_id=<%=customer_member.get(i).getCust_id()%>&buttonAction=delete">
						刪除
						</a>
						</td>
