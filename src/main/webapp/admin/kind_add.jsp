            ...
            <div class="row">
                ...
                <form action="prokindcud" method="POST">
                    <div class="form-group row">
                        種類名稱
                        <div class="col-sm-10">
                            <input class="form-control form-control-sm" type="text" name="enum_name" required="required">
                        </div>
                    </div>

                    <div id="our_button">
                        <br>
                        <button type="submit" class="btn btn-danger" value="add" name="buttonAction">送出</button>
                        　　　　　　　　　　　<!-- 請不要刪除這行全形空格，按鈕會跑版 -->
